    ...
    <div className='lg:h-[70vh] lg:w-[60vw] h-[55vh] sm:h-[60vh] sm:w-[85vw] w-[90vw] mx-auto flex flex-col justify-center text-center bg-white border border-gray-500 lg:p-10 sm:p-6 p-4 shadow-md rounded-lg'>
      ...
      <div className="text-left lg:pt-6 lg:pb-6 sm:pt-4 sm:pb-4 pt-2 pb-2">
        ...
        <div className="flex justify-center items-center space-x-3 sm:space-x-4">
          ...
          <a href='https://chatai-production-ae38.up.railway.app' target='blank' className='cursor-pointer lg:pt-2 lg:pb-4 lg:pl-4 lg:pr-4 sm:pt-2 sm:pb-3 sm:pl-3 sm:pr-3 pt-1 pb-1 pl-2 pr-2 border-2 border-gray-600 rounded-md font-bold flex justify-center items-center text-gray-600'>Live Site</a>
    ...
    <div className='lg:h-[70vh] lg:w-[60vw] h-[55vh] w-[80vw] mx-auto flex flex-col justify-center text-center bg-white border border-gray-500 lg:p-10 p-6 shadow-md rounded-lg'>
      ...
      <div className="text-left lg:pt-6 lg:pb-6 pt-3 pb-3">
        ...
        <div className="flex justify-center items-center space-x-4">
          ...
          <a href='https://chatapp-production-106e.up.railway.app' target='blank' className='cursor-pointer lg:pt-2 lg:pb-4 lg:pl-4 lg:pr-4 pt-1 pb-1 pl-2 pr-2 border-2 border-gray-600 rounded-md font-bold flex justify-center items-center text-gray-600'>
            Live Site
          </a>
